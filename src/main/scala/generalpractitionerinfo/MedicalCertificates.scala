...
object MedicalCertificates {
  def apply(medicalCertificateId: Int, medicalCertificate: MedicalCertificates): MedicalCertificates =
    new MedicalCertificates(medicalCertificateId, medicalCertificate.getMedicalCertificate)
}
